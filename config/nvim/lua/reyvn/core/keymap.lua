...
vim.keymap.set("n", "K", "<Plug>(LSPHover)", { desc = "LSP: Hover Documentation" })
...
vim.keymap.set("n", "[d", "<Plug>(LSPDiagnosticPrev)", { desc = "LSP: Previous Diagnostic" })
vim.keymap.set("n", "]d", "<Plug>(LSPDiagnosticNext)", { desc = "LSP: Next Diagnostic" })
