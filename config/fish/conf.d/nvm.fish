# script from : https://github.com/jorgebucaran/nvm.fish
...
# Use nvm that specified on .nvmrc file
# Copy this line when updating nvm
function __check_rvm --on-variable PWD --description 'Local NVM Use'
